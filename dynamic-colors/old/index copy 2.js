...
class Darklup {
          ...
          if (rules) {
            for (let j = 0; j < rules.length; j++) {
              ...
              if (rule.style) {
                ...
                // let borderWidth = rule.style.borderWidth;
                // if (borderWidth) {
                //   console.log(borderWidth);
                //   // console.log("%cHello World!", "color: red; font-size: 24px; font-weight: bold;");
                //   // console.log("%cThis is a warning message!", "background-color: yellow; color: black; font-weight: bold;");
                //   // console.log("%cThis is an error message!", "background-color: red; color: white; font-weight: bold;");
                // }
                let borderColor = rule.style.borderColor;

                let borderTopColor = rule.style.borderTopColor;
                let borderRightColor = rule.style.borderRightColor;
                let borderBottomColor = rule.style.borderBottomColor;
                let borderLeftColor = rule.style.borderLeftColor;

                let borders = [rule.style.borderTopColor, rule.style.borderRightColor, rule.style.borderBottomColor, rule.style.borderLeftColor];
                ...
                // if (borderColor) {
                //   if (borderColor.includes("var")) {
                //     // this.bgVars.push(borderColor);
                //     // darkBg = this.addDarklupWithVars(borderColor, "--darklup-bg");
                //     // filteredStyle += `background-color: ${darkBg};`;
                //   } else if (this.isRealColor(borderColor)) {
                //     // console.log(borderColor, `background-color: ${borderColor};`);
                //     console.log(`%c${borderColor}`, `background-color: ${borderColor};`);
                //     // console.log("%cThis is an error message!", "background-color: red; color: white; font-weight: bold;");
                //     // filteredStyle += `background-color: ${this.getDarkenBg(borderColor)};`;
                //   }
                // }

                // filteredStyle = this.addBorderColorCSS(rule.style, filteredStyle);
                if (bgColor) {
  ...
  addBorderColorCSS(styleRules, filteredStyle) {
    ...
    // let borderSide = {};
    // borders.forEach((b) => {
    //   borderSide[b] = `border${this.capitalize(b)}Color`;
    //   console.log(styleRules.borderSide[b]);
    //   // if(styleRules.borderColor){
    //   //   let BorderColor = styleRules.borderTopColor;
    //   //   filteredStyle += `border-${b}-color: ${styleRules.borderTopColor};`;
    //   //   console.log();
    //   // }
    // });
  ...
  getDarkenBg(c) {
    ...
    if (darkBg.getLuminance() * 10 > 4) {
      darkBg = darkBg.darken(85).toRgbString();
    } else {
