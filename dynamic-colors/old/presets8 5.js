...
class Darklup {
  ...
  applyDarklupDarkModeToAll() {
    for (let element of this.allElements) {
      ...
      if (tag == "a") {
        ...
        element.classList.add("wpc--darklup-element");
        ...
        if (!e.includes("*")) {
          ...
          if (element) {
            if (!this.hasBgColor(element)) {
              ...
              console.log(inheritedBg);
              element.dataset.inheritedBg = inheritedBg;
            }
            // element.classList.add("darklup-dark-ignore");
  ...
  setPrimaryBgBodyWidth() {
    ...
    // console.log(bodyElement, bodyBg, this.primaryBg);
  }
  ...
  applyDarkModeToDynamicElement(element) {
    ...
    if (tag == "a") {
      ...
      element.classList.add("wpc--darklup--observed");
    }
  }
  ...
  isDarkModeEnabled() {
    ...
    let getTriggerChecked = localStorage.getItem("triggerChecked");
