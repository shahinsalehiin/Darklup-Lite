...
class Darklup {
              ...
              for (const propertyName of rule.style) {
                if (propertyName.startsWith("--")) {
                  ...
                  if (isColor.isValid() && !propertyName.includes("darklup")) {
                    ...
                    customProperties[propertyName] = this.getDarkenBg(rule.style.getPropertyValue(propertyName).trim());
                  }
                }
              }
            }
  ...
  addGlobalInlineCSS(cssRules) {
    const darklupStyle = document.createElement("style");
    darklupStyle.setAttribute("id", "darklup-global-css");
