...
excludeSelectors = [".elementor-element-dq8izpp"];
        ...
        try {
          ...
          if (rules) {
            for (let j = 0; j < rules.length; j++) {
              ...
              if (rule.style) {
                // Alg One
                // if (this.excludedElements.includes(document.querySelector(rule.selectorText))) {
                //   // console.log(document.querySelector(rule.selectorText));
                // } else {
                //   // console.log(rule.selectorText);
                // }
                // Alg Two
                // if (this.allElements.includes(document.querySelector(rule.selectorText))) {
                //   // console.log(document.querySelector(rule.selectorText));
                //   // console.log(rule.selectorText);
                // } else {
                //   // console.log(rule.selectorText);
