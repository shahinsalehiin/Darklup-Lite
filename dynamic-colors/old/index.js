...
class Darklup {
  ...
  applyDarklupDarkModeToAll() {
    // console.log(this.allElements);
    // console.log("op");
    // let allAnchors = this.allElements.querySelectorAll("a");
    ...
    for (let element of this.allElements) {
      ...
      // hoverBackgroundColor = this.getHoverBackgroundColor(element);
      // console.log("Hover background color:", hoverBackgroundColor);
      // this.handleBoxShadow(element);
    }

    // let bgElements = document.querySelectorAll(".darklup_bg");
    // console.log(bgElements);
    // // const hoverBackgroundColors = this.getHoverBackgroundColors(this.allElements);
    // const hoverBackgroundColors = this.getHoverBackgroundColors(bgElements);
    // console.log("Hover background colors:", hoverBackgroundColors);
  ...
  handleCommonElement(element) {
    ...
    if (bgColor) {
      ...
      if (!this.bgColors.includes(bgColor)) {
        // console.log(this.bgColorsCount);

        this.bgColors.push(bgColor);
        element.classList.add(`darklup_bg_${this.bgColorsCount}`);
        // element.dataset.realBgColor = bgColor;
        // console.log("Bg Color Added", this.bgColorsCount);
        // console.log(this.bgColors, this.bgColors.length - 1, this.bgColorsCount);
      ...
      // console.log(bgColor);
      // element.dataset.realBgColor = `'${bgColor.toRgbString()}','${bgColor.toHexString()}'`;
  ...
  onElementHoverStart(event) {
    ...
    if (hoverBackgroundColor !== "rgba(0, 0, 0, 0)") {
      ...
      // event.target.dataset.darklupHover = hoverBackgroundColor;
      let tinyHover = tinycolor(hoverBackgroundColor);
      let hoverBg;
      if (tinyHover.getLuminance() * 10 > 4) {
        hoverBg = tinyHover.darken(85).toRgbString();
        // this.bgDarkenColors.push(tinyHover.darken(85).toRgbString());
        event.target.style.backgroundColor = hoverBg;
      } else {
        hoverBg = tinyHover.darken(10).toRgbString();
        // this.bgDarkenColors.push(tinyHover.darken(10).toRgbString());
        event.target.style.backgroundColor = hoverBg;
      }
  ...
  handleNewBgColors() {
    ...
    let allColors = ["rgb(246, 248, 249)", "rgb(255, 255, 255)", "rgba(229, 236, 240, 0.76)", "rgb(224, 224, 224)", "rgb(228, 235, 239)", "rgb(0, 0, 0)", "rgb(255, 0, 0)", "rgb(255, 128, 16)", "rgba(0, 0, 0, 0.7)", "rgb(255, 61, 61)", "rgba(0, 0, 0, 0.21)", "rgb(245, 128, 32)"];
    ...
    this.bgColors.forEach((c, i) => {
      ...
      if (this.bgTinyColors[i].getLuminance() * 10 > 4) {
        this.bgDarkenColors.push(this.bgTinyColors[i].darken(85).toRgbString());
      } else {
        this.bgDarkenColors.push(this.bgTinyColors[i].darken(10).toRgbString());
      }
      // console.log(`brightness and Luminance ${i}: ${c} , ${this.bgTinyColors[i].getBrightness()}, ${this.bgTinyColors[i].getLuminance() * 10}`);
    });
    // console.log(this.bgTinyColors);
  ...
  addInlineCSS() {
    ...
    // Step 2: Set the content of the style element
    // darklupStyle.textContent = `${darklupCSS}`;
    darklupStyle.textContent = darklupCSS;

    // Step 3: Append the style element to the head
