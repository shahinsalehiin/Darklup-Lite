...
abstract class Settings_Fields_Base {
  ...
  public function start_fields_section( $args ) {
    ...
    ?>
    <div class="<?php echo esc_attr( $args['class'] ); ?>" id="<?php echo esc_attr( $args['id'] ); ?>" style="display:<?php echo esc_attr( $args['display'] ); ?>;">
          ...
          <div class="darkluplite-row">
              <div class="darkluplite-col-sm-8 darkluplite-col-12 darkluplite-item-center">
                  <div class="darkluplite-title-icon">
                    <img class="admin-light-icon" src="<?php echo esc_url( $args['icon'] ); ?>" alt="<?php echo esc_attr( $args['title'] ); ?>" />
                    <img class="admin-dark-icon" src="<?php echo esc_url( $args['dark_icon'] ); ?>" alt="<?php echo esc_attr( $args['title'] ); ?>" />
                  </div>
